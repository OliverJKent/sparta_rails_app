...
class AccountHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_history" do
    assert_difference('AccountHistory.count') do
      post account_histories_url, params: { account_history: { account_id: @account_history.account_id, balance: @account_history.balance } }
    end
  ...
  test "should update account_history" do
    patch account_history_url(@account_history), params: { account_history: { account_id: @account_history.account_id, balance: @account_history.balance } }
